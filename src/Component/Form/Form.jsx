...
export default function Form() {
    ...
    return (
        <article className='d-flex'>
            <article className='sidebar col-lg-1 shadow min-vh-100'>
            ...
            <article className='col-lg-10 col-md-10 col-sm-10 mt-5 '>
                <article className='col-lg-10 col-md-10 col-sm-10 mt-5 p-2 w-100  shadow'>
                    <Nav variant="pills" >
                        ...
                        <Nav.Item className={`p-3 ${Styles.link}`}>
                            <Nav.Link eventKey="link-1"><Link to='/ApplicationForm' className='text-decoration-none text-black'>Application Form</Link></Nav.Link>
                        </Nav.Item>
                        <Nav.Item className={`p-3 ${Styles.link}`}>
